...
const Footer = () => {
    return (
    <div className="bg-gray-200 px-[200px] h-[80vh] mt-[50px]">
        <div className="flex justify-between py-[5%]">
            ...
            <div>
                ...
                <ul className="mt-2 space-y-2">
                    ...
                    <li className=" hover:text-red-700">Donate</li>
                    <li className=" hover:text-red-700">Contact</li>
                    
                    <Link to="/login">
                        <li className="py-[5%] hover:text-red-800">
                            Admin
                        </li>
                    </Link>
            ...
            <div className="w-full md:w-1/3">
                ...
                <p className="mt-2">BloodConnect PICT, Pune, India</p>
                <p className="mt-2">Phone: (+91) 9699673129</p>
